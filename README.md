...
> **جديد (غير مُصدَّر بعد — Unreleased)** — واجهة PySide6 محلية بالكامل (Phase C مكتملة على الفرع الرئيسي؛ أحدث إصدار مُصدَّر هو `v2.1.0`، وانتظر `v2.2.0` حتى اكتمال `docs/RELEASE_CHECKLIST_v2.2.0.md`)
